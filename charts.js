  ...
  if (!chartTimeSeriesInstance) {
    const optionsTimeSeries = {
      ...
      series: [
          {
            name: 'Funza',
            data: [132, 103, 115, 92, 87, 102, 91, 86, 65, 70, 66, 76, 101, 101, 80, 66, 85, 86, 85, 85, 85, 82, 84, 80, 80]
          },
          {
            name: 'Mosquera',
            data: [155, 121, 117, 105, 119, 114, 99, 86, 76, 109, 96, 104, 108, 108, 120, 99, 107, 110, 107, 106, 105, 107, 108, 102, 105]
          },
          {
            name: 'Madrid',
            data: [148, 125, 137, 118, 139, 120, 131, 112, 126, 108, 119, 105, 121, 100, 123, 109, 125, 126, 146, 128, 120, 134, 122, 151]
          }
      ],
      xaxis: {
          categories: [
